...
// Drop your real photos into /public/hero and list their filenames here.
// Until then this falls back to a plain gradient so nothing looks broken.
...
export function WelcomeHero({ firstName }: { firstName: string }) {
  ...
  return (
    <div className="relative w-full h-64 sm:h-80 rounded-3xl overflow-hidden shadow-lg">
      {/* Fallback gradient — always present underneath, in case a slide image is missing */}
      ...
      {/* Fade overlay so text stays readable over any photo */}
